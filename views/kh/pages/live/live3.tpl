...
<div class="register">
    ...
    <div class="register-form">
        <form class="layui-form" action="">
            ...
            <div class="layui-form-item switch-item">
                <div class="layui-input-block">
                    <input type="checkbox" name="assess_risk" lay-skin="switch" lay-text="{{ Lang.btn_switch || "是|否" }}" lay-filter="ass_switch"/>
            ...
            <div class="layui-row">
                ...
                <div class="layui-col-md5 layui-col-xs12 layui-col-md-offset2 layui-col-xs-offset0">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="hidden" id="card_path2" name="identity2_path" lay-verify="NotBlank"
                                   msg="{{ Lang.validate_identity2_path_not_null || "证件反面照片必须上传" }}"/>
                            <div class="layui-upload">
            ...
            <div class="layui-form-item submit-item">
                <div class="layui-input-block">
                    ...
                    <button class="layui-btn" lay-submit lay-filter="live3_next" onclick="return false;">{{ Lang.btn_sub || "提交" || "提交" }}</button>
                </div>
            </div>
        </form>
    </div>
