        ...
        <form class="layui-form" action="">
            ...
            <div class="layui-row">
                <div class="layui-col-md5 layui-col-xs12">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="date_of_birth" id="date_of_birth" lay-verify="NotBlank" msg="{{ Lang.validate_birthday_not_null || "出生日期必填项" }}" disabled="disabled" class="layui-input" id="test2">
                        </div>
                    </div>
            ...
            <div class="layui-row">
                <div class="layui-col-md12 layui-col-xs12">
                  ...
                  <p style="color:red">{{ Lang.form_register_password_prompt || "提示：此密码为，您注册邮箱登陆客户管理中心的密码。MT4交易密码请于注册邮箱查收。" }}</p>
        ...
        layui.use('form', function(){
            ...
            form.verify({
                identity_no : function(value){
                    ...
                    if(Getsex(value)!=$("select[name='gender']").val() && identityType == 1){
                      return '{{ Lang.validate_gender_indentity || "称呼与身份证号不符" }}'
                    }
