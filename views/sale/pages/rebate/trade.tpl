...
{% block js_assets %}
    <script>
        ...
        layui.use(['form', 'laydate', 'table'], function () {
            ...
            tableIns = table.render({
                ...
                , cols: [[
                    ...
                    , {
                        field: 'rateRebate', title: '{{ Lang.table_rate_rebate || "返佣比率" }}', sort: true, align: 'center', templet: function (d) {
                            if (d.statistics) {
                                return "";
                            }
                    ...
                    , {
                        ...
                        align: 'center',
                        templet: function (d) {
                            return d.commission_amount / 100;
                        }
                    }
        ...
        function search(search_form_data) {
            ...
            var end_time = search_form_data.end_time;
            if(search_form_data.start_time){
                start_time = search_form_data.start_time +" 00:00:00";
            }

            if(search_form_data.end_time){
                end_time = search_form_data.end_time +" 23:59:59";
            }
