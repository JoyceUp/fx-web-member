...
<div class="layadmin-user-login-main">
	<div class="layadmin-user-login-box layadmin-user-login-header">
		<h2>
			{{ Lang.page_msg_login || "登录" }}<i style="font-style: normal;color:#999;font-size:10px;margin-left: 5px;">{{ version }}</i></h2>
		<p></p>
	</div>
	<div class="layadmin-user-login-box layadmin-user-login-body layui-form">
		<form class="layui-form" action="">
			...
			<div class="layui-form-item">
				<button class="layui-btn layui-btn-fluid" lay-submit=""  lay-filter="user-login-submit" onclick="return false;">{{ Lang.btn_loginn || "登录" }}</button>
			</div>
		</form>
	</div>
</div>
