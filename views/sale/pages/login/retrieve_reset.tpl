		...
		<div class="layadmin-user-login-box layadmin-user-login-body layui-form">
			<form class="layui-form" action="">
				...
				<div class="layui-form-item mt30">
					<button class="layui-btn layui-btn-fluid" lay-submit="" {% if link== false%}disabled style="background: #bbb" {% endif %}  lay-filter="user-login-submit">{{ Lang.btn_sub || "提交" || "提交" }}</button>
				</div>
			</form>
		</div>
	</div>
...
<script>
   ...
   form.verify({
    ...
    function submit(data){
        ...
        $.post("/sale/password/retrieve/reset",params,function(result){
