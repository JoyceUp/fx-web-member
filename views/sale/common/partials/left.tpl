<div id="sidebar">
    <ul class="side_nav">
        ...
        <li class="side_nav_itmes {% if active == 'ib' %}itmes_active{% endif %}"><!--当前子级选中状态class="active"-->

            <div class="jt"><img src="/assets/member/images/img/nav04.png"></div>
            <a class="n2" href="/sale/ib/page"><i class="left_nav_icon iconfont icon-profile"></i>{{ Lang.menu_sale_ib || "代理信息" }}</a>
            <ul>

                <li {% if active == "ib" %} class="active" {% endif %}>
                    <a href="/sale/ib/page">{{ Lang.menu_sale_ib_list || "代理列表" }}</a>
                </li>
        ...
        <li class="side_nav_itmes {% if active == 'results' %}itmes_active{% endif %}"><!--当前子级选中状态class="active"-->

            <div class="jt"><img src="/assets/member/images/img/nav04.png"></div>
            <a class="n4" href="/sale/results"><i class="left_nav_icon iconfont icon-icon-test1"></i>{{ Lang.menu_sale_results || "我的业绩" }}</a>
            <ul>

                <li {% if active == "results" %} class="active" {% endif %} >
                    <a href="/sale/results">{{ Lang.menu_sale_results_list || "业绩列表" }}</a>
                </li>
