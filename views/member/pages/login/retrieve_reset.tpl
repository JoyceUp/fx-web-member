...
<body>
	...
	<div class="layadmin-user-login-main">
		<div class="layadmin-user-login-box layadmin-user-login-header">
			<h2>
				{{ Lang.page_restpassword_title || "重置密码" }}
			</h2>
			<p>{{ msg }}</p>
		</div>
		<div class="layadmin-user-login-box layadmin-user-login-body layui-form">
			<form class="layui-form" action="">
				...
				<div class="layui-form-item mt30">
					<button class="layui-btn layui-btn-fluid" lay-submit=""  lay-filter="user-login-submit" onclick="return false;">{{ Lang.btn_sub || "提交" || "提交" }}</button>
				</div>
			</form>
		</div>
	</div>
...
<script>
   ...
   form.verify({
    ...
    function submit(data){
        ...
        $.post("/member/password/retrieve/reset",params,function(result){
