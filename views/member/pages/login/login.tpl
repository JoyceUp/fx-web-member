	...
	<div class="layadmin-user-login-main">
		...
		<div class="layadmin-user-login-box layadmin-user-login-body layui-form">
			...
			<div class="layui-form-item">
				...
				<input type="text" name="username"  lay-verify="username" placeholder="{{ Lang.form_placeholder_login_email_or_mt || "邮箱或mt账号" }}" class="layui-input"/>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<a href="/member/register" class="fr">{{ Lang.page_login_register || "注册账户" }}</a>
			</div>
			<div class="layui-form-item">
				<button class="layui-btn layui-btn-fluid" lay-submit=""  lay-filter="user-login-submit" onclick="return false;">{{ Lang.btn_login || "登 录" || "登录" }}</button>
			</div>
			{#	<div class="layui-form-item">
