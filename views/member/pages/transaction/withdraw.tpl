                                ...
                                <div class="layui-tab-content">
                                    ...
                                    <div class="layui-tab-item layui-show">
                                        <div class="from_alert">
                                            ...
                                            <p>{{ Lang.page_disclaimers_msg_txt5 || "5.  每次最低出金金额为[withdraw_min_limit]美金" }}</p>
                                            {#<p>{{ Lang.page_disclaimers_msg_txt6 || "6. 银行卡出金免费。" }}</p>#}
                                        </div>

                                        <div class="form">

                                            <form class="layui-form w600" action="" autocomplete="off">
                                                <div class="layui-form-item">
                                                    ...
                                                    <div class="layui-form-mid" id="balanceBank" style="display:none">{{ Lang.form_text_available_balance || "可用余额" }}: <span id="bank_balance">$0.00</span></div>
                                                </div>
                                                ...
                                                <div class="layui-form-item">
                                                    ...
                                                    <div class="layui-input-inline">
                                                        <input type="text" id="bank_amount" name="amount" lay-verify="balance" class="layui-input" oninput="usd2rmb(this, 'bank_pay_amount')"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="layui-form-item">
                                                    ...
                                                    <div class="layui-input-inline">
                                                        <select style="width: 240px" id="bankcard" name="bankcard" lay-verify="NotBlank" msg="{{ Lang.validate_withdraw_bankcard_not_chose || "请选择收款银行" }}">
                                                            <option value="">{{ Lang.form_select_invite_type || "请选择" }}</option>
                                                            {% for b in banklist %}
                                                    ...
                                                    <div class="layui-form-mid btn">
                                                        <a class="layui-btn layui-btn-sm" href="/member/user/bankinfo">{{ Lang.btn_manager_bank_card || "管理银行卡" }}</a>
                                                    </div>
                                                </div>

                                                <div class="layui-form-item">
                                                    <div class="layui-input-block">
                                                        <button class="layui-btn" lay-submit lay-filter="bank_confirm" onclick="return false;">{{ Lang.btn_sub || "提交" || "提交" }}</button>
                                        ...
                                        <div class="form">
                                            ...
                                            <form class="layui-form w600" action="" autocomplete="off">
                                                ...
                                                <div class="layui-form-item">
                                                    <label class="layui-form-label"><i>*</i>{{ Lang.form_label_application_amount || "申请金额(USD)" }}：</label>
                                                    <div class="layui-input-inline">
                                                        <input type="text" id="tt_amount" name="amount" lay-verify="balance" class="layui-input" oninput="usd2rmb(this, 'tt_pay_amount')"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="layui-form-item">
                                                    ...
                                                    <div class="layui-input-inline">
                                                        <input type="text" name="bankcard_no" lay-verify="NotBlank" msg="{{ Lang.validate_withdraw_bankcard_not_chose || "请选择收款银行" }}" value="{{ tt.card_no }}" disabled="disabled" autocomplete="off" class="layui-input">
                                                    </div>
                                                    <div class="layui-form-mid btn">
                                                ...
                                                <div class="layui-form-item">
                                                    <div class="layui-input-block">
                                                        <button class="layui-btn" lay-submit lay-filter="tt_confirm" onclick="return false;">{{ Lang.btn_sub || "提交" || "提交" }}</button>
