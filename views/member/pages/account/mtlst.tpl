...
{% block content %}
                ...
                <div class="main_head">
                    ...
                    <div id="search_box">
                        ...
                        <form class="layui-form" action="">
                            ...
                            {#<label class="input-title">{{ Lang.form_placeholder_account_type || "账户类型" }}：</label>#}
                            <div class="layui-input-inline">
                                <select name="account_type" lay-filter="type">
                                    <option value="">{{ Lang.form_placeholder_account_type || "账户类型" }}</option>
                                    {% for at in Lang.select.member.account.account_type %}
    ...
    <div id="detail" style="display:none">
        <form class="layui-form show-detail" action="">
            ...
            <div class="d-item">
                <label>{{ Lang.form_label_ib_name || "代理姓名" }}：</label>
