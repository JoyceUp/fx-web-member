...
{% block js_assets %}
    <script>
        ...
        //出入金类型
        var inOutTypeMap = new Object();
        {% for at in Lang.select.member.funds.in_out_type %}
        inOutTypeMap[{{ at.value }}] ="{{ at.label }}";
        {% endfor %}
        //查看详情
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.status == 200) {
                        ...
                        console.log(channel_type,deposit)
                        if (deposit) {
                            //取消申请的必须参数
                            ...
                            $("#" + content + " .amount").html(deposit.amount / 100);           //申请金额
                            $("#" + content + " .fee").html(deposit.fee / 100 || 0);            //手续费
                            $("#" + content + " .pay_amount").html(deposit.pay_amount / 100);   //支付金额USD
                            ...
                            if(channel_type == 102){
                                ...
                                $("#" + content + " .bank_name").html(deposit.bank_name + " " + deposit.city + " " + deposit.branch_name + "<br/>" + deposit.card_no);         //银行名称
                            }
                            ...
                            $("#" + content + " .status").html(stateMap[deposit.status] || '处理中');    //订单状态
                            ...
                            if (deposit.status == 2 && (deposit.channel_type == 101 || deposit.channel_type == 102)) {
        ...
        layui.use(['form','laydate','table'],function(){
            ...
            tableIns = table.render({
                ...
                cols:[[
                   ...
                   /* {field:'type',title:'出入金类型',sort:true,align:'center',templet:function(d){
                            return inOutTypeMap[d.type];
                        }},*/
   ...
   {#微信支付 2#}
    <div id="detail_2" style="display:none">
        <form class="layui-form show-detail" action="">
            ...
            <div class="d-item">
                <label>{{ Lang.form_text_gmt_modified || "更新时间" }}:</label>
                <span class="gmt_modified">{{ datas.state }}</span>
            </div>
   ...
   {# 出金-银行卡 101#}
    <div id="detail_101" style="display:none">
        <form class="layui-form show-detail" action="">
            ...
            <div class="canceApply" style="display:none">
                <button class="layui-btn" lay-submit="" lay-filter="cance" onclick="javascript:return false;">{{ Lang.btn_cancel_apply || "取消申请" }}</button>
            </div>
        </form>
    </div>
