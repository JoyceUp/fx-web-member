                        ...
                        <form class="layui-form" action="">
                            <div class="layui-form-item">
                                <div class="layui-inline">
                                    <label class="layui-form-label">{{ Lang.form_label_balance_time || "返利日期" }}</label>
...
{% block js_assets %}
    <script>
        ...
        function showDetail(start_time) {
            ...
            table.render({
                elem: '#detail_table'
                , url: "/ib/rebates/balance/list"
                , method: 'post'
                , where: {
                    start_time: start_time
                }
                , cols: [[
                    {field: 'account_no', title: '{{ Lang.table_account_no_1 || "代理账号" }}',width: 100, align: 'center'}
                    ...
                    , {field: 'source_account_type', title: '{{ Lang.table_source_account_type_1 || "客户账户类型" }}',width: 160, align: 'center', templet: function (d) {
                ...
                , cols: [[
                    ...
                    , {
                        field: 'daily_amount', title: '{{ Lang.table_amount_1 || "返利金额(USD)" }}', align: 'center', templet: function (d) {
                            ...
                            if (d.daily_amount) {
                                return '<a onclick="showDetail(\'' + d.rebate_date + '\')"  href="javascript:;">' + (d.daily_amount / 100) + '</a>';
                            } else {
                                return 0;
                            }
