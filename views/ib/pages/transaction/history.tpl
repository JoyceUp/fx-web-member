...
{% block content %}
    <div class="main_content">
        <div class="main_content_holder">
            <div id="fund">
                <div class="main_head">
                    <div class="main_head_unit">{{ Lang.form_text_history_transaction || " 历史交易 " }}</div>
                    <div id="search_box">
                        <form class="layui-form"  action="">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-inline">
                                    <label class="layui-form-label">{{ Lang.form_label_close_time_gmt || "平仓时间（GMT）" }}</label>
                                    <div class="layui-inline" style="width: 160px;">
                                        <input type="text" name="start_time" id="startT" autocomplete="off" class="layui-input">
                                    </div>
                                    <div class="layui-form-mid">-</div>
                                    <div class="layui-inline" style="width: 160px;">
                                        <input type="text" name="end_time" id="endT" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                <div class="layui-inline">
    ...
    <script>
        ...
        layui.use(['form','laydate','table'], function(){
            ...
            tableIns = table.render({
                elem : '#tra'
                ,url : '/ib/transaction/history_datas'
                ,cellMinWidth : 80
                ,page:true
                ,cols : [[
            ...
            function search(search_form_data){
                tableIns.reload({
                    where:{
                        ...
                        source_account_user_name:search_form_data.source_account_user_name,
