module.exports = {
    ...
    register: {
        ...
        capital_source: [        //资金来源
            ...
            {value: 6, label: '遗产继承'},
            {value: 7, label: '出售物业'},
            {value: 8, label: '出售/清算投资'}
        ],
        annual_income: [        //年收入
            {value: 1, label: '少于$25,000'},
            {value: 2, label: '$25,000-$49,999'},
            {value: 3, label: '$50,000-$99,999'},
            {value: 4, label: '$100,000-$249,999'},
            {value: 5, label: '$250,000-$1000,000'},
            {value: 6, label: '多于$1,000,000'}
        ],
        total_asset: [        //总资产
            {value: 1, label: '少于$25,000'},
            {value: 2, label: '$25,000-$49,999'},
            ...
            {value: 6, label: '多于$1,000,000'},
            // {value: 7, label: '$5,000,000-$9,999,999'},
            // {value: 8, label: '多于$10,000,000'}
        ],
        experience: [        //是否有交易经验
            {value: 1, label: '是'},
            {value: 2, label: '否'}
    ...
    funds: {
        ...
        funds_type: [
            ...
            {value: 6, label: '转账-转入'},
            {value: 7, label: '余额清零'},
            /*{value: 8, label: '入金-交易返佣'},
            {value: 9, label: '入金-返利转入余额'},*/
